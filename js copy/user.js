...
async function login(evt) {
  ...
  try {
    ...
    if (error.message === "Incorrect username or password. Please try again.") {
      // Show error message 
...
async function signup(evt) {
  ...
  try {
    ...
    if (error.message === "Username is already taken") {
      // Show error message for username already taken
      $signupError.text(error.message);
      $signupError.show();
    } else {
      // Show general error message
      $signupError.text("An error occurred during signup.");
      $signupError.show();
